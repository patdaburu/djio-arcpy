...
# -*- coding: utf-8 -*-
#
# djio_arcpy documentation build configuration file
#
...
release = djio_arcpy.__release__
...
htmlhelp_basename = 'djio_arcpydoc'
...
latex_documents = [
    (master_doc, 'djio_arcpy.tex', 'djio_arcpy Documentation',
     'patdaburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'djio_arcpy', 'djio_arcpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'djio_arcpy', 'djio_arcpy Documentation',
     author, 'djio_arcpy', 'One line description of project.',
     'Miscellaneous'),
]
