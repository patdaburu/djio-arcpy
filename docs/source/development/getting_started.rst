...
The source code for the `djio_arcpy` project lives at
`github <https://github.com/patdaburu/djio_arcpy>`_.  You can use `git clone` to get it.

.. code-block:: bash

   git clone https://github.com/patdaburu/djio_arcpy
